...
enum MessageType: Int {
	case RandomNumber, GameBegin, GameOver, Move, String, Flip, Attack,Jump, GetDown, Special, Players, StartGameProperties, ChosenCharacter, LoseLife, Death, MyScore, Scores
}
